SUBROUTINE calculate_reliabilities_supp (cmonth, cleadb, cleade, csupp, &
...
!      coded by Tom Hamill, Feb 2014, (303) 497-3060, tom.hamill@noaa.gov

! ---- this routine is same as calculate_reliabilities, but writes data out to different "supp" files

CHARACTER*3, INTENT(IN) :: cmonth, cleadb, cleade
CHARACTER*2, INTENT(IN) :: csupp
CHARACTER*(*), INTENT(IN) :: output_data_directory

INTEGER, INTENT(IN) :: nxa, nya, ntrainsamps, nyears, imonth
INTEGER, INTENT(IN) :: date_anal(ntrainsamps)
...
threshfield(:,:) = 0.1 ! POP
PRINT *, '-------------------------------------------------------------------------'
outfile = TRIM(output_data_directory) // '/reliability_ppn_pwat_ccpa_supp'// &
   csupp//'_analog_POP_'//cmonth//'_'//cleadb//'_to_'//cleade//'.dat'
...
PRINT *, '-------------------------------------------------------------------------'
outfile = TRIM(output_data_directory) // '/reliability_ppn_pwat_ccpa_supp'// &
   csupp//'_analog_1mm_'//cmonth//'_'//cleadb//'_to_'//cleade//'.dat'
print *,'writing reliability information to ',TRIM(outfile)
CALL relia_bss_analog_ccpa ( outfile, nxa, nya, ntrainsamps, iccpa_mask, imonth, nyears, &
...
PRINT *, '-------------------------------------------------------------------------'
outfile = TRIM(output_data_directory) // '/reliability_ppn_pwat_ccpa_supp'// &
   csupp//'_analog_2p5mm_'//cmonth//'_'//cleadb//'_to_'//cleade//'.dat'
print *,'writing reliability information to ',TRIM(outfile)
CALL relia_bss_analog_ccpa ( outfile, nxa, nya, ntrainsamps, iccpa_mask, imonth, nyears, &
...
PRINT *, '-------------------------------------------------------------------------'
outfile = TRIM(output_data_directory) // '/reliability_ppn_pwat_ccpa_supp'// &
   csupp//'_analog_5mm_'//cmonth//'_'//cleadb//'_to_'//cleade//'.dat'
print *,'writing reliability information to ',TRIM(outfile)
CALL relia_bss_analog_ccpa ( outfile, nxa, nya, ntrainsamps, iccpa_mask, imonth, nyears, &
...
PRINT *, '-------------------------------------------------------------------------'
outfile = TRIM(output_data_directory) // '/reliability_ppn_pwat_ccpa_supp'// &
   csupp//'_analog_10mm_'//cmonth//'_'//cleadb//'_to_'//cleade//'.dat'
print *,'writing reliability information to ',TRIM(outfile)
CALL relia_bss_analog_ccpa ( outfile, nxa, nya, ntrainsamps, iccpa_mask, imonth, nyears, &
...
PRINT *, '-------------------------------------------------------------------------'
outfile = TRIM(output_data_directory) // '/reliability_ppn_pwat_ccpa_supp'//& 
   csupp//'_analog_25mm_'//cmonth//'_'//cleadb//'_to_'//cleade//'.dat'
print *,'writing reliability information to ',TRIM(outfile)
CALL relia_bss_analog_ccpa ( outfile, nxa, nya, ntrainsamps, iccpa_mask, imonth, nyears, &
...
PRINT *, '-------------------------------------------------------------------------'
outfile = TRIM(output_data_directory) // '/reliability_ppn_pwat_ccpa_supp'//&
   csupp//'_analog_50mm_'//cmonth//'_'//cleadb//'_to_'//cleade//'.dat'
print *,'writing reliability information to ',TRIM(outfile)
CALL relia_bss_analog_ccpa ( outfile, nxa, nya, ntrainsamps, iccpa_mask, imonth, nyears, &
     date_anal, rlons_anal, rlats_anal, apcp_anal, threshfield, prob_50mm, climo_50mm)

! normally below you would think that for the quantiles of the distribution the climatological
...
PRINT *, '-------------------------------------------------------------------------'
outfile = TRIM(output_data_directory) // '/reliability_ppn_pwat_ccpa_supp'//&
   csupp//'_analog_q50_'//cmonth//'_'//cleadb//'_to_'//cleade//'.dat'
print *,'writing reliability information to ',TRIM(outfile)
CALL relia_bss_analog_ccpa ( outfile, nxa, nya, ntrainsamps, iccpa_mask, imonth, nyears, &
...
PRINT *, '-------------------------------------------------------------------------'
outfile = TRIM(output_data_directory) // '/reliability_ppn_pwat_ccpa_supp'//&
   csupp//'_analog_q67_'//cmonth//'_'//cleadb//'_to_'//cleade//'.dat'
print *,'writing reliability information to ',TRIM(outfile)
CALL relia_bss_analog_ccpa ( outfile, nxa, nya, ntrainsamps, iccpa_mask, imonth, nyears, &
...
PRINT *, '-------------------------------------------------------------------------'
outfile = TRIM(output_data_directory) // '/reliability_ppn_pwat_ccpa_supp'//&
   csupp//'_analog_q80_'//cmonth//'_'//cleadb//'_to_'//cleade//'.dat'
print *,'writing reliability information to ',TRIM(outfile)
CALL relia_bss_analog_ccpa ( outfile, nxa, nya, ntrainsamps, iccpa_mask, imonth, nyears, &
...
PRINT *, '-------------------------------------------------------------------------'
outfile = TRIM(output_data_directory) // '/reliability_ppn_pwat_ccpa_supp'//&
   csupp//'_analog_q90_'//cmonth//'_'//cleadb//'_to_'//cleade//'.dat'
print *,'writing reliability information to ',TRIM(outfile)
CALL relia_bss_analog_ccpa ( outfile, nxa, nya, ntrainsamps, iccpa_mask, imonth, nyears, &
...
climop = climo_95
outfile = TRIM(output_data_directory) // '/reliability_ppn_pwat_ccpa_supp'//&
   csupp//'_analog_q95_'//cmonth//'_'//cleadb//'_to_'//cleade//'.dat'
PRINT *, '-------------------------------------------------------------------------'
print *,'writing reliability information to ',TRIM(outfile)
CALL relia_bss_analog_ccpa ( outfile, nxa, nya, ntrainsamps, iccpa_mask, imonth, nyears, &
