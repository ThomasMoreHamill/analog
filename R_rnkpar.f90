Subroutine R_rnkpar (XDONT, IRNGT, NDIM, NORD)
...
! _________________________________________________________
      Integer, Intent (In) :: NDIM, NORD
      Real, Dimension (NDIM), Intent (In) :: XDONT
      Integer, Dimension (NDIM), Intent (Out) :: IRNGT
! __________________________________________________________
      Real    :: XPIV, XPIV0, XWRK, XWRK1, XMIN, XMAX
!
      Integer, Dimension (NDIM) :: ILOWT, IHIGT
